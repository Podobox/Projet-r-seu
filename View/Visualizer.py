                ...
                match MAP.grid[column][row].building:
                    ...
                    case House():
                        if MAP.grid[column][row].building.burning:
                            ...
                            if not (MAP.grid[column][row].building.tile.posy == row and MAP.grid[column][
                                row].building.tile.posx == column):
                                riskLevel = 0
                    ...
                    case Wheat_Farm():
                        if MAP.grid[column][row].building.burning:
                            ...
                            self.showDesirabilityLevel(
                                row, column, tileDIM, origin, desirabilityLevel)
                        elif MAP.grid[column][row].building.tile.posy == row and MAP.grid[column][
                            row].building.tile.posx == column:
                            imgName = 'Farm'
                            imgCode = '00001'
                            compenX = cellSize * 2
...
# Workers if not finishedfrom operator import imod
# from turtle import window_width
# import pygame as pg
# import tkinter as tk
#
